...
import com.example.simvoice.entity.DailyLimit;
import com.example.simvoice.exception.BusinessException;
import com.example.simvoice.mapper.DailyLimitMapper;
    ...
    public boolean checkAndIncrement(String openid, Integer type) {
        ...
        switch (type) {
            ...
            case 2: // 生成图片
                ...
                if (currentCount >= maxLimit) {
                    throw new BusinessException(ResultCode.TOO_MANY_REQUESTS, "今日生成图片次数已达上限（10次）");
                }
